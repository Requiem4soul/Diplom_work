...
class ParkingSystem:
    ...
    def check_spots_main(self, park_spots, car_spots, frame):
        ...
        ip_address = '127.0.0.1'  # Установим IP-адрес, который вы указали
        ...
        save_update_to_db(frame, free_spots, ip_address)  # Сохраняем данные об обновлении
        return 0
    ...
    def process_video_with_tracking(self, model, input_video_path,
        ...
        while True:
            ...
            if results[0].boxes.id is not None:
                ...
                if frame_count % 200 == 0 and frame_count != 0:  # Вызываем сохранение данных каждые 200 кадров
